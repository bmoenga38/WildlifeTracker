...
## Installation
* `git clone <https://github.com/.git>` this repository
* `cd WildlifeTracker`
...
## Contact Details
```bash
You can contact me at  iamjmochache@gmail.com
```

## License
- This project is licensed under the MIT Open Source license Copyright (c) 2023. [LICENCE](https://github.com/peter-wachira/WildlifeTracker/blob/master/LICENCE)
